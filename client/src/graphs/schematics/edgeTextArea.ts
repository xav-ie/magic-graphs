...
const opacityAdjustedTextArea = (opacity: number) => (textArea: TextAreaNoLocation) => {
...
export const animateInTextArea = (progress: number) => (textArea: TextAreaNoLocation | undefined) => {
